...
protected:
	...
	// and 0x10 more here: setCursorDirection @0x700790 writes +0x5E20 where
	// ours is +0x5AB8, taking the total shift to 0x368.
	char		_bfme_hole_beforeWin32Cursor[0x10];
