...
public:  // ***************************************************************************************
	...
	// BFME has nine more virtuals ahead of isScrolling: W3DMouse's
	// setCursorDirection @0x700790 reaches isScrolling at +0xA4 and
	// getScrollAmount at +0xB4 where this header puts them at +0x80 and
	// +0x90, and the two keep their four-slot spacing. Names and signatures
	// are unknown; they are parked immediately before the first pinned slot
	// so that nothing below them moves.
	virtual void _bfme_ingameui_slot0( void ) { }
	virtual void _bfme_ingameui_slot1( void ) { }
	virtual void _bfme_ingameui_slot2( void ) { }
	virtual void _bfme_ingameui_slot3( void ) { }
	virtual void _bfme_ingameui_slot4( void ) { }
	virtual void _bfme_ingameui_slot5( void ) { }
	virtual void _bfme_ingameui_slot6( void ) { }
	virtual void _bfme_ingameui_slot7( void ) { }
	virtual void _bfme_ingameui_slot8( void ) { }
