...
public:
	...
	// BFME has one more virtual ahead of getLayerHeight than ZH:
	// Pathfinder::adjustCoordToCell @0x3D6040 calls it through slot 0x1C
	// where this header puts it at 0x18. Only the slot index is proven -
	// where the added method really sits, and what it does, is unknown - so
	// it is a stub placed immediately in front of the pin.
	virtual void _bfme_tl_slot6( void ) { }
