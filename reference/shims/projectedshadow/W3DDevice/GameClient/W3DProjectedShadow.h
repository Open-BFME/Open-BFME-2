...
*/
	...
	private:
		...
		// BFME has 12 more bytes ahead of m_shadowCamera: init @0x7AF630 stores
		// the camera at +0x20 where ours lands at +0x14, and the texture manager
		// at +0x24C where ours is at +0x240 - the same +0xC for both.
		char			_bfme_hole_beforeShadowCamera[12];
