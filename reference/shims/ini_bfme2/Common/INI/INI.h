// TU-scoped shim: Open-BFME-1's hand model of BFME's INI (its
// Code/GameEngine/Include/Common/INI/INI.h) at BFME2's size. Scoped by
// -Ireference/shims/ini_bfme2 on the unit's // cl: line.
#pragma once
...
private:
	// Not ported. BFME2's INI is 0x34 bytes larger than BFME1's 0x848: a stack
	// INI in SubsystemInterfaceList::initSubsystem (0x001B5266) sits 0x34 deeper
	// in a 0x884-byte frame, and INI::INI() at 0x0002CDB0 writes as far as
	// [this+0x870].
