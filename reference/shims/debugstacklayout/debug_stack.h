  ...
  public:
    ...
    */
    ...
    /**
      ...
      \param fullPath when true keep the full file path, otherwise strip to
             the filename (BFME2 retail adds this trailing parameter; the
             sole retail caller passes true)
    */
