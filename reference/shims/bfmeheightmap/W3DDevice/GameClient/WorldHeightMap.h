...
// BFME: no WorldHeightMapInterfaceClass base — retail reads m_width at
// [this+8] / m_height at [this+0xc] (removeAllTerrainBibs body @0x6CB050),
// i.e. the original Generals layout without ZH's interface vptr at +8.
