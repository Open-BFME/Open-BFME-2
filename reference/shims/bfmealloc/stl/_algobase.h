...
// BFME SHIM: declaration only. __copy_trivial is a real out-of-line function
// in game.dat at 0x000179B0 and every call site reaches it with a plain
// three-argument cdecl call, so the shipped STLport did not define it inline.
...
template <class _InputIter, class _OutputIter>
__forceinline _OutputIter __copy_ptrs(_InputIter __first, _InputIter __last, _OutputIter __result, __true_type ) {
...
template <class _InputIter, class _OutputIter>
__forceinline _OutputIter __copy_aux(_InputIter __first, _InputIter __last, _OutputIter __result, __true_type ) {
...
template <class _InputIter, class _OutputIter>
__forceinline _OutputIter __copy_aux(_InputIter __first, _InputIter __last, _OutputIter __result, __false_type ) {
  return __copy(__first, __last, __result, 
