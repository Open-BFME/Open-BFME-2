// TU-scoped BFME2 ownership variant of the pinned GeneralsMD template.
// The destructor omits the dead post-release clear: the independent retail
// destructor at RVA17098D loads its pointer and tailcalls Release_Ref.
/*
