...
// -----------------------------------------------------
// BFME keeps AsciiString::releaseBuffer out of line too: the same function
// @0x635670 calls it at 0x887940 when destroying its by-value parameter.
...
// -----------------------------------------------------
// BFME keeps AsciiString::set(const AsciiString&) out of line: retail's
// GameSpyInfo::addToSavedIgnoreList @0x635670 calls it at 0x887C90 rather
// than inlining the ref-count dance the way this header's inline body does.
