// TU-scoped constructor interface correction: retail forwards an owning texture handle by const reference.
...
class ParticleBufferClass : public RenderObjClass
{
	public:
		...
		ParticleBufferClass(ParticleEmitterClass *emitter, unsigned int buffer_size,
			...
			float max_age, float future_start, const BFME2ParticleTextureHandle &tex, ShaderClass shader, bool pingpong,
