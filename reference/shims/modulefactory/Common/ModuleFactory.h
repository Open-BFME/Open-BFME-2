...
//				 list and create it
//
// BFME2 layout: ModuleFactory::findModuleTemplate (0x0025674F) reads
// m_moduleTemplateMap at this+0x10 ("add esi,0x10"); the reference layout
// (vptr + AsciiString-sized SubsystemInterface state + Snapshot vptr = 0xC)
// puts it at +0xC. That is 4 unaccounted bytes ahead of the map. The body
// gives no evidence for WHICH base class or field grew, so this is a named
// gap rather than a guessed field. ObjectCreationListStore has a similarly-
// shaped but differently-sized gap (+0x10 vs its reference +0) despite also
// deriving from SubsystemInterface, which rules out "SubsystemInterface grew
// by 4 bytes" as a shared cause -- these are two independent per-class gaps.
//
///////////////////////////////////////////////////////////////////////////////////////////////////
