// SHIM: getObjectMemoryPool is not virtual in BFME.
//
// The reference MemoryPoolObject contributes TWO vtable slots -- the destructor
// and a pure getObjectMemoryPool -- which pushes File::open to slot 2. Retail
// calls open through [eax+4], slot 1, and every File slot downstream agrees with
// a single leading destructor (close 2, read 3, write 4, seek 5), matching the
// File declaration in Code/GameEngine/Source/Common/System/File.cpp, which is
// byte-matched 43/43. So BFME's pooled objects do not carry this second slot.
/*
...
private: \
	MemoryPool *getObjectMemoryPool() \
	{ \
