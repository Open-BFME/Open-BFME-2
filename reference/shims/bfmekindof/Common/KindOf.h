...
enum KindOfType
{
	...
	// BFME has two more kinds here than ZH. TunnelTracker::updateNemesis
	// @0xF90D0 tests STRUCTURE, INFANTRY and VEHICLE with 7, 8 and 9 exactly
	// as this header numbers them, then tests AIRCRAFT with 12 - so the two
	// extra entries sit between VEHICLE and AIRCRAFT. Their names are unknown.
	KINDOF_BFME_HOLE_10,
	KINDOF_BFME_HOLE_11,
