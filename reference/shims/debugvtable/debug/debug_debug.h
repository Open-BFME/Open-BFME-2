...
DLOG( "My HResult is: " << Debug::HResult(SomeHRESULTValue) << "\n" );
  ...
  */
  ...
  virtual Debug& operator<<(Width &w)
  {
    m_width=w.m_width;
    return *this;
  }
  ...
  */
  ...
  virtual Debug& operator<<(FillChar &c)
  {
    m_fillChar=c.m_fill;
    return *this;
  }
  ...
  */
  ...
  virtual Debug& operator<<(const Format &f)
  {
    operator<<(f.m_buffer);
    return *this;
  }
...
private:
  ...
  */
  virtual void UpdateFrameStatus(FrameHashEntry &entry);
  ...
  */
  virtual void FlushOutput(bool defaultLog=true);
  ...
  */
  virtual void AddPatternEntry(unsigned types, bool isActive, const char *pattern);
  ...
  */
  virtual void ExecCommand(const char *cmdstart, const char *cmdend);
