...
protected:
    ...
    // BFME2 ownership-only scope. The SceneClass virtual prefix through slot16
    ...
    RefRenderObjListClass ReleaseList;       // 0xA4
    MultiListClass<RenderObjClass> _bfme_changed_objects; // 0xBC; non-owning
    MultiListClass<RenderObjClass> _bfme_forced_objects;  // 0xD4; non-owning
    RefRenderObjListClass _bfme_visible_objects;         // 0xEC
    unsigned int _bfme_visibility_token;    // 0x104; constructor1; getter slot17
