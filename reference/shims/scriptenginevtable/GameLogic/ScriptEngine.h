...
public:
	...
	// BFME puts three more virtuals here, immediately after the destructor and
	// ahead of init. Scripts.cpp pins them: ScriptAction::WriteActionDataChunk
	// (0x003513F0) reaches getActionTemplate through vtable +0x28 where this
	// header lands it at +0x1C, and the same trio shows up on GameWindowManager
	// and DisplayStringManager -- see docs/lessons.md. Names and signatures are
	// unknown; parked here so nothing below them moves.
	virtual void _bfme_se_slot1( void ) { }
	virtual void _bfme_se_slot2( void ) { }
	virtual void _bfme_se_slot3( void ) { }
