...
condition or action. */
// BFME's Template has NO base and no vtable: script_conditions.cpp already
// derived the layout from `lea edi,[esi+0x10720]` pointing straight at m_uiName,
// with sizeof 0x7C. That is why ScriptAction::WriteActionDataChunk reads
// m_internalNameKey at +0x0C where the Zero Hour class, with MemoryPoolObject's
// vptr in front, puts it at +0x10.
class Template
{
// friend bad for MPOs. (srj)
//friend class ScriptEngine;
