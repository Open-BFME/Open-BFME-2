// GameWindowManager.h -- BFME shadow shim. ZH GeneralsMD header with the class
// layout rebuilt to match lotrbfme.exe's GameWindowManager vtable (73 slots,
// recovered from the retail primary vtable near RVA 0xCF8B60):
//  * three BFME-only stub virtuals at slots 6-8 (shared by ~113 retail vtables
//    of this family; NOT in the SubsystemInterface base because the Display
//    branch doesn't have them -- Display::getWidth stays at vtable+0x2c).
//  * allocateNewWindow + the 22 *DrawFunc getters are NOT virtual in BFME (kept
//    here as non-virtual inlines so callers still compile).
//  * one BFME-only virtual sits between addWindowToParentAtEnd and
//    winSendSystemMsg (retail slot 52; name/signature pending RE).
//  * winGetTextSize / winTextLabelToText / winFindFont are non-virtual in BFME.
// Result: winSendSystemMsg lands at vtable+0xd4 (slot 53) as retail call sites encode.
/*
...
// BFME2 copy of reference/open-bfme-1/reference/shims/sweep/GameClient/
// GameWindowManager.h; only the five extra virtuals below differ.
#pragma once
...
public:
	...
	// BFME: three stub virtuals occupy slots 6-8 in this family (retail stub
	// bodies: xor al,al;ret 4 / ret / ret 4). Names/signatures pending RE; the
	// slots must exist here so the rest of the vtable keeps its retail layout.
	virtual Bool bfme_gwm_6( void * ) { return FALSE; }
	virtual void bfme_gwm_7( void ) { }
	virtual void bfme_gwm_8( void * ) { }

	// BFME2: five more virtuals than BFME1. Every retail call on TheWindowManager
	// (0x00DFEF1C) at or above ZH slot 0x3C sits 0x14 higher: winSendSystemMsg
	// 0xD4->0xE8, winGetWindowFromId 0xDC->0xF0, winCreateLayout 0x6C->0x80,
	// gogoGadgetPushButton 0x3C->0x50, winFontHeight 0x10C->0x120. No call pins
	// where between 0x24 and 0x3C they sit, so they are placeholders here.
	virtual void bfme2_gwm_extra0( void ) { }
	virtual void bfme2_gwm_extra1( void ) { }
	virtual void bfme2_gwm_extra2( void ) { }
	virtual void bfme2_gwm_extra3( void ) { }
	virtual void bfme2_gwm_extra4( void ) { }
	...
	GameWindow *allocateNewWindow( void ) { return NULL; }  ///< BFME: non-virtual (was pure virtual in ZH)
	...
	GameWinDrawFunc getPushButtonImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getPushButtonDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getCheckBoxImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getCheckBoxDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getRadioButtonImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getRadioButtonDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getTabControlImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getTabControlDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getListBoxImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getListBoxDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getComboBoxImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getComboBoxDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getHorizontalSliderImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getHorizontalSliderDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getVerticalSliderImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getVerticalSliderDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getProgressBarImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getProgressBarDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getStaticTextImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getStaticTextDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getTextEntryImageDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	GameWinDrawFunc getTextEntryDrawFunc( void ) { return NULL; }  ///< BFME: non-virtual (pure virtual in ZH)
	...
	virtual void bfme_gwm_52( GameWindow *, GameWindow * ) { }  ///< BFME-only virtual (retail vtable slot 52); name/signature pending RE
	...
	virtual void winFormatText( GameFont *font, UnicodeString text, Color color,
															Int x, Int y, Int width, Int height );
	void winGetTextSize( GameFont *font, UnicodeString text, 
															 Int *width, Int *height, Int maxWidth );
	UnicodeString winTextLabelToText( AsciiString label );  ///< convert localizable text label to real text
	GameFont *winFindFont( AsciiString fontName, Int pointSize, Bool bold );  ///< get a font given a name
