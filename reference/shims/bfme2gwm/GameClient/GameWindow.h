// BFME2 copy of the Zero Hour GameClient/GameWindow.h; only m_bfme2Unknown differs.
/*
...
protected:
	...
	// BFME2: four more bytes than Zero Hour ahead of the instance data. Every
	// draw-data read in the gadget draws sits 4 higher (enabled/disabled/hilite
	// arrays, e.g. +0xB4 -> +0xB8); what the field holds is unknown.
	Int m_bfme2Unknown;
