// SubsystemInterface.h -- BFME shadow shim. Verbatim ZH GeneralsMD header.
// NOTE: retail lotrbfme.exe has three extra stub virtuals at slots 6-8 in the
// GameWindowManager/InGameUI family (~113 vtables share them), but NOT in the
// Display branch (Display::getWidth stays at slot 11 / vtable+0x2c), so they
// are modeled per-class (see GameWindowManager.h), not in this base.
/*
