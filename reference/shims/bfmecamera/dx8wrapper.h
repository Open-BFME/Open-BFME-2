// Camera-only BFME2 wrapper interface. Projection submission is out of line;
// its two Matrix4 values and float depth bias are reconstructed from retail.
/*
...
protected:
	...
	*/
	...
	// Retail maintains the transposed source and the biased device matrix separately.
	static Matrix4x4 DeviceProjectionMatrix;
	static float ProjectionDepthBias;
