...
protected:
	...
	// BFME2 stores and copies a second Matrix4 at 0x38C. The setter at
	// RVA 0x133DA0 writes all 16 floats; its rendering role is unresolved.
	mutable Matrix4x4				AdditionalTransform;
