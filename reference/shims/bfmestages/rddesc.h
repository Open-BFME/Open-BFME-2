...
// BFME2 keeps D3D9 capabilities and adapter identifiers in every render
// device description: retail's element is 0x5B8 bytes, and its copy
// assignment moves 0x130 bytes of caps from +0x24 and 0x44C bytes of adapter
// identifier from +0x154, with the resolution array at +0x5A0.  These are the
// D3D9 sizes (D3DCAPS9 is 304 bytes, D3DADAPTER_IDENTIFIER9 1100 with four-
// byte packing), so both members take the D3D9 layouts dx8wrapper.cpp's
// device creation and enumeration already use.
#pragma pack(push,4)
