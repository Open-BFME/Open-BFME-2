...
// BFME2 allows SIXTEEN texture stages, not eight. Read out of retail:
// DX8Wrapper::Set_DX8_Texture_Stage_State at 0x000661DD guards its stage
// index with `cmp ebx,0x10`, where this header's value of 8 makes our
// build emit `cmp ebp,8`. This shim changes ONLY that constant -- the
// banked_segline copy of this header also carries an unsigned-vs-unsigned
// short Draw_Triangles signature and an initialiser change, which are
// separate claims and do not belong in a unit that is not testing them.
