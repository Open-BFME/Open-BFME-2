...
**8.59% of the game's retail `.text` has exact byte coverage** — 692,202 C++ bytes
plus 3,350 ASM-only bytes. Source-backed reconstruction accounts for 8.68% of
