...
**8.61% of the game's retail `.text` has exact byte coverage** — 693,996 C++ bytes
plus 3,350 ASM-only bytes. Source-backed reconstruction accounts for 8.70% of
