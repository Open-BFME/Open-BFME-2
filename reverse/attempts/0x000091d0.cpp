// ?do_get@?$num_get@DV?$istreambuf_iterator@DV?$char_traits@D@_STL@@@_STL@@@_STL@@MBE?AV?$istreambuf_iterator@DV?$char_traits@D@_STL@@@2@V32@0AAVios_base@2@AAHAA_N@Z
// partial score=0.85 date=2026-09-02
// ?do_get@?$num_get@... (bool &), the narrow twin
// partial score=0.85 date=2026-09-02
// cl: /EHsc /MD /D_STLP_USE_STATIC_LIB
//
// Found by tools/vtable_gaps.py as the one slot of the narrow num_get vtable
...
// compiles to exactly 636 bytes against 636, and the same holds for the
// other twin, which is not a coincidence twice. And decode_calls.py reads the
// REL32s as numpunct<char>::truename and falsename, which only the boolalpha
