...
// stlport
//
// STLport 4.5.3 basic_string<char>::_M_insert_aux, the slow half of
// insert(iterator, char). Both halves of the reallocating path run through
// __copy_trivial, whose empty-range test is why the two memmove calls sit
// behind branches; only the raw byte allocator stays external.
