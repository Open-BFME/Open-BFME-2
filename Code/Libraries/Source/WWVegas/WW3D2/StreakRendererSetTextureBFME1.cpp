...
// (?Cross_Product@Vector3 is claimed from this file now)
				Vector3::Cross_Product(segment[intersectionIndex - 1].EdgePlane[TOP_EDGE], segment[intersectionIndex].EdgePlane[TOP_EDGE], &(intersection[intersectionIndex][TOP_EDGE].Direction));
...
// (folded home from colmathobbobb.cpp, which no longer points here)
// (?Cross_Product@Vector3 is claimed from this file now)
				Vector3::Cross_Product(segment[intersectionIndex - 1].EdgePlane[BOTTOM_EDGE], segment[intersectionIndex].EdgePlane[BOTTOM_EDGE], &(intersection[intersectionIndex][BOTTOM_EDGE].Direction));
