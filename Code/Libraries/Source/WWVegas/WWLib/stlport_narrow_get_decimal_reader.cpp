...
// stlport
//
// STLport 4.5.3 decimal integer reader. The upstream __get_decimal_integer
...
template bool __cdecl __get_decimal_integer<narrow_iterator, long>(
        narrow_iterator &, narrow_iterator &, long &);
