...
namespace _STL {
template<> class basic_streambuf<char,char_traits<char> > { public: typedef char_traits<char>::int_type int_type; int_type sgetc(); int_type sbumpc(); };
...
//    const ctype<char>& __ct =    use_facet<ctype<char> >(__loc) ;
    ...
    const basic_string<char> __truename  = __np.truename();
    const basic_string<char> __falsename = __np.falsename();
    bool __true_ok  = true;
