...
std::pair<UnicodeNameSet::iterator, bool> Force_UnicodeStringSet_insert(UnicodeNameSet &s, const UnicodeString &v)
{
    return s.insert(v);
}
UnicodeNameSet::iterator Force_UnicodeStringSet_find(UnicodeNameSet &s, const UnicodeString &v)
{
    return s.find(v);
}
