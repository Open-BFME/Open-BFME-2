...
// stlport
//
// STLport 4.5.3 narrow signed 64-bit integer accumulator. The implementation
...
template bool __cdecl __get_integer<narrow_iterator, __int64>(
        narrow_iterator &, narrow_iterator &, int, __int64 &, int, bool, char,
