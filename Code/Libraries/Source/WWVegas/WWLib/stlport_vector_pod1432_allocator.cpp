...
// stlport
//
// BFME2's 1432-byte Pod vector allocator at RVA 0x00552FA2 (28B: imul-0x598
...
// strength-reduces n*1432 to lea+shl; retail keeps the imul, which this
...
// bodies. Size-carrying body, so the BfmePod1432 placeholder name is honest
// per the POD-PLACEHOLDER LAW (element construction never passes through
// here). The BfmePod1432 layout mirrors the home TU declaration.
struct BfmePod1432 { int a[358]; };
#include <memory>
template class _STL::allocator<BfmePod1432>;
