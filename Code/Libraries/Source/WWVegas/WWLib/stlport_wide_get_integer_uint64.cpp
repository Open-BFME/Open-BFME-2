...
// stlport
//
// STLport 4.5.3 wide unsigned 64-bit integer accumulator. The implementation
...
template bool __cdecl __get_integer<wide_iterator, unsigned __int64>(
        wide_iterator &, wide_iterator &, int, unsigned __int64 &,
