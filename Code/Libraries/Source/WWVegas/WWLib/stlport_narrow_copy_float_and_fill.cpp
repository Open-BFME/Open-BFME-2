...
// stlport
//
// STLport 4.6 narrow floating-point padding helper. The iterator's copying
...
template narrow_output_iterator __copy_float_and_fill<
		char, narrow_output_iterator>(
		const char *, const char *, narrow_output_iterator,
