...
__declspec(dllimport) __forceinline bool __get_fdigit_or_sep(
		char &character, char separator, const char *digits)
{
...
template bool __copy_grouped_digits<narrow_iterator, char>(
		narrow_iterator &, narrow_iterator &, narrow_string &,
		const char *, char, const narrow_string &, bool &);
