...
// stlport
//
// BFME2's 2148-byte Pod vector allocator at RVA 0x005507FE (28B: imul-0x864
...
// strength-reduces n*2148 to lea+shl; retail keeps the imul, which this
...
// bodies. Size-carrying body, so the BfmePod2148 placeholder name is honest
// per the POD-PLACEHOLDER LAW (element construction never passes through
// here). The BfmePod2148 layout mirrors the home TU declaration.
struct BfmePod2148 { int a[537]; };
#include <memory>
template class _STL::allocator<BfmePod2148>;
