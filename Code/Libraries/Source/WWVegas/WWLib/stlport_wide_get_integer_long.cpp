...
// stlport
//
// STLport 4.5.3 wide signed-long integer accumulator. The implementation
...
template bool __cdecl __get_integer<wide_iterator, long>(
        wide_iterator &, wide_iterator &, int, long &, int, bool, char,
