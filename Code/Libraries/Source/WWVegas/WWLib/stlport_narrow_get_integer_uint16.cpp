...
// stlport
//
// STLport 4.5.3 narrow unsigned-short integer accumulator. The implementation
        ...
        const narrow_string &grouping, const __false_type &)
{
    ...
    Integer over_base = static_cast<Integer>(0xFFFFU) /
...
template bool __cdecl __get_integer<narrow_iterator, unsigned short>(
        narrow_iterator &, narrow_iterator &, int, unsigned short &,
