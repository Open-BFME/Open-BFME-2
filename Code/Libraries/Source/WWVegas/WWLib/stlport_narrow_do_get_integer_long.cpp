...
// stlport
//
// STLport 4.5.3 narrow signed-long integer scanner. The implementation is the
// upstream _M_do_get_integer body from vendor/stlport/stl/_num_get.c.
...
template narrow_iterator __cdecl _M_do_get_integer<
        narrow_iterator, long, char>(
        narrow_iterator &, narrow_iterator &, ios_base &,
        ios_base::iostate &, long &, char *);
