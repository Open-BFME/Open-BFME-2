...
// S4Cmp00625880>, retail 0x00625A70, 96 bytes. The body carried only a
...
template void __push_heap<S4SortElem8 *, int, S4SortElem8, S4Cmp00625880>(
	S4SortElem8 *, int, int, S4SortElem8, S4Cmp00625880);
