...
// stlport
//
// BFME2's 1372-byte Pod vector allocator at RVA 0x00552F83 (28B: imul-0x55c
...
// strength-reduces n*1372 to lea+shl; retail keeps the imul, which this
...
// bodies. Size-carrying body, so the BfmePod1372 placeholder name is honest
// per the POD-PLACEHOLDER LAW (element construction never passes through
// here). The BfmePod1372 layout mirrors the home TU declaration.
struct BfmePod1372 { int a[343]; };
#include <memory>
template class _STL::allocator<BfmePod1372>;
