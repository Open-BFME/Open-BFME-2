...
// stlport
//
// STLport 4.5.3 narrow signed-long integer accumulator. The implementation
        ...
        const narrow_string &grouping, const __true_type &)
{
    ...
    Integer over_base = static_cast<Integer>(0x80000000UL) /
    ...
    {
        value = overflow
                ? negative ? static_cast<Integer>(0x80000000UL)
                           : static_cast<Integer>(0x7FFFFFFFL)
...
template bool __cdecl __get_integer<narrow_iterator, long>(
        narrow_iterator &, narrow_iterator &, int, long &, int, bool, char,
