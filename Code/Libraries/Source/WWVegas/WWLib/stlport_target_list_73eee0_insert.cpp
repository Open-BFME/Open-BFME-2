...
// Keep node creation out of line while the iterator constructor stays visible.
template<>
TargetListAt0073EEE0::_Node *TargetListAt0073EEE0::_M_create_node(const Rva0073EEE0ListValue &value);

__declspec(noinline) void ForceRealTargetListInsert(
