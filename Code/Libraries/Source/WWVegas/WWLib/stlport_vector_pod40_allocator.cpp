...
// stlport
//
// BFME2's 40-byte Pod vector allocator at RVA 0x000B4039 (28B: imul-0x28
...
// strength-reduces n*40 to lea+shl; retail keeps the imul, which this
...
// bodies. Size-carrying body, so the BfmePod40 placeholder name is honest
// per the POD-PLACEHOLDER LAW (element construction never passes through
// here). The BfmePod40 layout mirrors the home TU declaration.
struct BfmePod40 { int a[10]; };
#include <memory>
template class _STL::allocator<BfmePod40>;
