...
// stlport
//
// STLport 4.5.3 long double decimal accumulator over a wide string. Same
// upstream __get_integer body from vendor/stlport/stl/_num_get.c as the
// signed-long twins, instantiated for the arguments money_get<wchar_t>'s
...
template bool __cdecl __get_integer<wchar_t *, long double>(
        wchar_t *&, wchar_t *&, int, long double &,
