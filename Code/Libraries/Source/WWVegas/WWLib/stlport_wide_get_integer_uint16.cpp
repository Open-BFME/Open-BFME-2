...
// stlport
//
// STLport 4.5.3 wide unsigned-short integer accumulator. The implementation
...
template bool __cdecl __get_integer<wide_iterator, unsigned short>(
        wide_iterator &, wide_iterator &, int, unsigned short &,
