...
// stlport
//
// STLport 4.5.3 narrow unsigned 64-bit integer accumulator. The implementation
        ...
        const narrow_string &grouping, const __false_type &)
{
    ...
    Integer over_base = static_cast<Integer>(0xFFFFFFFFFFFFFFFFUI64) /
    ...
    {
        value = overflow
                ? static_cast<Integer>(0xFFFFFFFFFFFFFFFFUI64)
...
template bool __cdecl __get_integer<narrow_iterator, unsigned __int64>(
        narrow_iterator &, narrow_iterator &, int, unsigned __int64 &,
