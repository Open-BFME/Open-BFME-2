...
// stlport
//
// STLport 4.5.3 narrow signed-long decimal accumulator. The implementation
        ...
        const narrow_string &grouping, const __false_type &)
{
    ...
    Integer over_base = static_cast<Integer>(0x7FFFFFFFL) /
...
template bool __cdecl __get_integer<narrow_iterator, long>(
        narrow_iterator &, narrow_iterator &, int, long &,
