...
// stlport
//
// STLport 4.5.3 __get_decimal_integer over a narrow string, accumulating into a
// long double. This is the instantiation money_get<char>::do_get reaches
...
template bool __cdecl __get_decimal_integer<char *, long double>(
