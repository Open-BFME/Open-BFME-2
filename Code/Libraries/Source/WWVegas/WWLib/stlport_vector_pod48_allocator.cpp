...
// stlport
//
// BFME2's 48-byte Pod vector allocator at RVA 0x003F40D3 (28B: imul-0x30
...
// strength-reduces n*48 to lea+shl; retail keeps the imul, which this
...
// bodies. Size-carrying body, so the BfmePod48 placeholder name is honest
// per the POD-PLACEHOLDER LAW (element construction never passes through
// here). The BfmePod48 layout mirrors the home TU declaration.
struct BfmePod48 { int a[12]; };
#include <memory>
template class _STL::allocator<BfmePod48>;
