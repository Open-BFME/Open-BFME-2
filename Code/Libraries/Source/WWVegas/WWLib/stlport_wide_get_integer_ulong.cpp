...
// stlport
//
// STLport 4.5.3 wide unsigned-long integer accumulator. The implementation
...
template bool __cdecl __get_integer<wide_iterator, unsigned long>(
        wide_iterator &, wide_iterator &, int, unsigned long &,
