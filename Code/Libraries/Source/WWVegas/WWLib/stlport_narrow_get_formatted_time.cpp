...
// stlport
//
// STLport 4.5.3 __get_formatted_time, the worker behind time_get::do_get_time
// and do_get_date. Its identity was already pinned - the four banked do_get
// bodies all read this address out of their own REL32 - and its four callees
...
template const char *__cdecl __get_formatted_time<narrow_iterator, const char *>(
		narrow_iterator, narrow_iterator, const char *, const char *,
