// cl: /MD -Ireference/shims/gamespy -Ireference/open-bfme-1/Code/GameEngine/Source/GameNetwork/GameSpy/qr2 /DNDEBUG
...
#include <string.h>
/* Retail imports both byte-order directions as htonl/htons. */
#undef ntohl
#undef ntohs
#define ntohl htonl
#define ntohs htons
...
static int qr2_get_sockaddrin(const char *host, int port, struct sockaddr_in *saddr, struct hostent **savehent);
...
qr2_error_t qr2_create_socket(/*[out]*/SOCKET *sock, const char *ip, /*[in/out]*/int * port)
{
	...
	{
		qr2_get_sockaddrin(ip,baseport,&saddr,NULL);
