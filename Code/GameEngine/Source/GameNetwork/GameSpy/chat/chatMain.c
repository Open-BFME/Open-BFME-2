...
/* BFME2 GameSpy Chat reconstruction from nitrocaster/GameSpy
 * d1deb2d1a951cf77933dda040b8d311cc09815a7, src/GameSpy/Chat/chatMain.c.
 * Retail passes caller server/port directly, preserves the earlier boolean IRC nickname rules, and uses the54-command dispatch model. The995-byte connection constructor is anchored by all five independently compiled public connect wrappers.
 * Retail imports _strcmpi; no callee-name alias is hidden by relocation masking.
...
/* Retail imports msvcr71!_strcmpi at IAT0x00BBA518. */
#undef strcasecmp
#define strcasecmp _strcmpi
/* Retail preserves the earlier boolean IRC nickname predicate. */
#undef VALID_NICK_CHARS
