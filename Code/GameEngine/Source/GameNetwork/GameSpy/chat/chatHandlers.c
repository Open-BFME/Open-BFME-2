 ...
 * d1deb2d1a951cf77933dda040b8d311cc09815a7, src/GameSpy/Chat/chatHandlers.c.
 * Retail omits later UDP relay filter and dispatch branches. Its54 command/string/handler pairs are independently read at VA0x00DDBC38; count54 at0x00DDBDE8. Switch-table data is checked separately and excluded from code claims.
...
ciServerMessageType serverMessageTypes[] = 
{
	...
	/* The retail dispatch table has54 commands, without later RPL_GETUDPRELAY. */
