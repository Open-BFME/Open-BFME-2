// cl: /DNDEBUG /MD -Ireference/shims/gamespy -Ireference/open-bfme-1/Code/GameEngine/Source/GameNetwork/GameSpy/gp
...
{
// BFME2 uses the SDK select check, not the later reconnect workaround.
	int aWriteFlag  = 0;
	int aExceptFlag = 0;
	int aReturnCode = 0;
