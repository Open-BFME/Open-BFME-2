...
// base UpdateModule xfer via rowed 0x0044DF9F, then int at +0x24 via Xfer
// slot 0x7C plus int at +0x28 via Xfer slot 0x7C.
...
void ClickReactionBehavior::xfer(Xfer *xfer)
{
	xfer->Version1();
