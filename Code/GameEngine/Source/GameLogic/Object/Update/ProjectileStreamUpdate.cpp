...
// m_indexInLogic). unclaimed_scan's layout report flagged cullFrontOfList and
// considerDying with a uniform -4 displacement shift against retail; both
// only touch ProjectileStreamUpdate's own members (m_firstValidIndex,
// m_nextFreeIndex, m_owningObject, m_projectileIDs), which sit directly after
// the UpdateModule base, so the extra dword upstream of them is the fix.
