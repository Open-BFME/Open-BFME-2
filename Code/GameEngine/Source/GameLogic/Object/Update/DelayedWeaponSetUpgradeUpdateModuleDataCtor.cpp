// cl: /O1 /DNDEBUG /MD
//
// DelayedWeaponSetUpgradeUpdateModuleData file-unit (parse first; the ctor
// remains pinned for a follow-up).
//
// ?buildFieldParse@DelayedWeaponSetUpgradeUpdateModuleData@@SAXAAVMultiIniFieldParse@@@Z,
// retail 0x004882D3, 17 bytes. Single-table parse proc (table 0x00C6BB18)
