// cl: /O1 /GX /DNDEBUG /MD
//
// ?friend_newModuleData@StanceTemplateUpdateModuleData@@SAPAVModuleData@@PAVINI@@@Z,
...
// StanceTemplateUpdateModuleData::buildFieldParse proc (table 0x00C424B0 whose
...
class StanceTemplateUpdateModuleData
{
public:
	StanceTemplateUpdateModuleData();
	virtual ~StanceTemplateUpdateModuleData();
...
// ?friend_newModuleData@StanceTemplateUpdateModuleData@@SAPAVModuleData@@PAVINI@@@Z
ModuleData *StanceTemplateUpdateModuleData::friend_newModuleData(INI *ini)
{
	StanceTemplateUpdateModuleData *data = new StanceTemplateUpdateModuleData;
	if (ini)
		ini->initFromINIMultiProc(data, StanceTemplateUpdateModuleData::buildFieldParse);
