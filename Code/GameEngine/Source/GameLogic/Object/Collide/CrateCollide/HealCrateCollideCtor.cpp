...
// vtable 0x00C5A868, whose slot2 is the name getter 0x004BC839 pushing
// HealCrateCollide) and the +0x0C/+0x10 secondary slots (address-of
...
// (SalvageCrateCollideCtor.cpp). Class identity is the HealCrate retail
// cluster (pool key rowed at 0x004BC858, name getter at 0x004BC839, the
// instance factory at 0x00251157 is the sole raw caller).
...
// ??0HealCrateCollide@@QAE@PAVThing@@PBVModuleData@@@Z
