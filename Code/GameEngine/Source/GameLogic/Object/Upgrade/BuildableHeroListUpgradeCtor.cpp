// cl: /O1 /DNDEBUG /MD
//
// ??0BuildableHeroListUpgrade@@QAE@PAVThing@@PBVModuleData@@@Z, retail 0x004B8332, 49 bytes.
// BuildableHeroListUpgrade behavior ctor over the pinned UpgradeModule base
...
// DIR32-masked). The rowed name getter at 0x4B82CB proves the class; the
// rowed instance factory 0x25087E is the sole raw caller. Row supersedes the
// ctor pin.
...
// ??0BuildableHeroListUpgrade@@QAE@PAVThing@@PBVModuleData@@@Z @0x4B8332
BuildableHeroListUpgrade::BuildableHeroListUpgrade(Thing *thing, const ModuleData *moduleData)
