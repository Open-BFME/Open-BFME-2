...
// ??1Rva004B8732@@UAE@XZ in Rva0024A797Grandchildren.cpp): Version(1,2) via
// Xfer slot 0x28 then version-gated base UpdateModule xfer via rowed
// 0x44DF9F then bool at +0x24 via Xfer slot 0x90. Layout is UpdateModule
// base 0x20 plus E1 vptr at +0x20 giving +0x24 start (cf. rowed dtor 0x4B8732
// four vptrs). Identity is slot 3 plus the UpdateModule base call; class
...
void Rva004B8732::xfer(Xfer *xfer)
{
