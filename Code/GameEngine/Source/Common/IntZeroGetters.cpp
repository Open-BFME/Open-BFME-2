...
BFME_INT_ZERO_GETTER(Rva0017EF80ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0017EFC0ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0017F000ZeroGetter)
BFME_INT_ZERO_GETTER(Rva00181242ZeroGetter)
BFME_INT_ZERO_GETTER(Rva006026D0ZeroGetter)
BFME_INT_ZERO_GETTER(Rva00602820ZeroGetter)
BFME_INT_ZERO_GETTER(Rva00602860ZeroGetter)
BFME_INT_ZERO_GETTER(Rva00658147ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0065E7CAZeroGetter)
BFME_INT_ZERO_GETTER(Rva0065EC9AZeroGetter)
BFME_INT_ZERO_GETTER(Rva00104076ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0010615FZeroGetter)
BFME_INT_ZERO_GETTER(Rva0017FB0CZeroGetter)
BFME_INT_ZERO_GETTER(Rva001D909EZeroGetter)
BFME_INT_ZERO_GETTER(Rva001E35C7ZeroGetter)
BFME_INT_ZERO_GETTER(Rva001E368BZeroGetter)
BFME_INT_ZERO_GETTER(Rva001E38B6ZeroGetter)
BFME_INT_ZERO_GETTER(Rva001E4012ZeroGetter)
BFME_INT_ZERO_GETTER(Rva001F376BZeroGetter)
BFME_INT_ZERO_GETTER(Rva00215EE9ZeroGetter)
BFME_INT_ZERO_GETTER(Rva00219837ZeroGetter)
BFME_INT_ZERO_GETTER(Rva002221A6ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0023C921ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0025DD45ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0025DE73ZeroGetter)
BFME_INT_ZERO_GETTER(Rva002632C4ZeroGetter)
BFME_INT_ZERO_GETTER(Rva002632DEZeroGetter)
BFME_INT_ZERO_GETTER(Rva0027175CZeroGetter)
BFME_INT_ZERO_GETTER(Rva00271776ZeroGetter)
BFME_INT_ZERO_GETTER(Rva0028AC5FZeroGetter)
