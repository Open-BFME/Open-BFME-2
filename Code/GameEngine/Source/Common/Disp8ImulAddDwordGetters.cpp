...
BFME_IMUL_ADD_DWORD_GETTER(Rva001EB10CImulAddField, 0x24)
BFME_IMUL_ADD_DWORD_GETTER(Rva002B2F00ImulAddField, 0x2C)
BFME_IMUL_ADD_DWORD_GETTER(Rva0033A8F0ImulAddField, 0x14)
BFME_IMUL_ADD_DWORD_GETTER(Rva0040A667ImulAddField, 0x68)
BFME_IMUL_ADD_DWORD_GETTER(Rva0047A875ImulAddField, 0x18)
BFME_IMUL_ADD_DWORD_GETTER(Rva004AE909ImulAddField, 0x54)
BFME_IMUL_ADD_DWORD_GETTER(Rva0051E3E5ImulAddField, 0x50)
BFME_IMUL_ADD_DWORD_GETTER(Rva0053FCCBImulAddField, 0x28)
BFME_IMUL_ADD_DWORD_GETTER(Rva00564C40ImulAddField, 0x58)
BFME_IMUL_ADD_DWORD_GETTER(Rva00583B05ImulAddField, 0x1C)
BFME_IMUL_ADD_DWORD_GETTER(Rva00587311ImulAddField, 0x3C)
BFME_IMUL_ADD_DWORD_GETTER(Rva005C809DImulAddField, 0x48)
