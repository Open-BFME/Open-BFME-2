...
// ??1Rva0045B134@@UAE@XZ in Rva0024A797Derived.cpp): Version(1,1) via Xfer
// slot 0x28 then base UpdateModule xfer via rowed 0x0044DF9F then IsLightCRC
// early-out via Xfer slot 0x10 then bool at +0x20 via Xfer slot 0x90.
// Layout is UpdateModule base 0x20 giving +0x20 start. Identity is slot 3
...
class Rva0045B134 : public UpdateModule
{
protected:
...
void Rva0045B134::xfer(Xfer *xfer)
{
