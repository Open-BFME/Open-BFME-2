...
// ??1Rva004839D3@@UAE@XZ in Rva0024A797Grandchildren.cpp): base UpdateModule
// xfer via rowed 0x44DF9F then IsLightCRC early-out via Xfer slot 0x10 then
// Version1 via rowed 0x53EE then two uints at +0x24/+0x28 via Xfer slot
// 0x78. Layout is UpdateModule base 0x20 plus E1 vptr at +0x20 giving +0x24
// start (cf. rowed dtor 0x4839D3 four vptrs). Identity is slot 3 plus the
// UpdateModule base call; class name stays honest Rva address name.
...
void Rva004839D3::xfer(Xfer *xfer)
{
