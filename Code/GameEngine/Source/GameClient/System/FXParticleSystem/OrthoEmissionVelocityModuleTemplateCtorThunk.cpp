...
// Open-BFME5: clean-C++ OrthoEmissionVelocityModuleTemplate default constructor.
...
class OrthoEmissionVelocityModuleTemplate : public CategoryModuleTemplate<4>,
    public OrthoEmissionVelocityInfo
{
public:
